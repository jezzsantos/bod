...
{
    internal class OfflineClinicRequestValidator : AbstractValidator<OfflineClinicRequest>
    {
        public OfflineClinicRequestValidator(IIdentifierFactory identifierFactory)
        {
            RuleFor(dto => dto.Id)
