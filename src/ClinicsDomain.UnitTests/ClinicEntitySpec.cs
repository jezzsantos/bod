    ...
    public class ClinicEntitySpec
    {
        ...
        public void WhenSetManufacturer_ThenManufactured()
        {
            ...
            this.entity.Manufacturer.Should()
                .Be(manufacturer);
            this.entity.Events[1].Should().BeOfType<Events.Clinic.ManufacturerChanged>();
        }
        ...
        public void WhenOffline_ThenUnavailable()
        {
            ...
            this.entity.Events[4].Should().BeOfType<Events.Clinic.UnavailabilitySlotAdded>();
            this.entity.Events[4].As<Events.Clinic.UnavailabilitySlotAdded>().EntityId.Should().Be("anunavailbilityid1");
        }
        ...
        public void WhenAddUnavailableWithIntersectingSlotWithSameCauseNoReference_ThenReplacesEntity()
        {
            ...
            this.entity.Events[4].Should().BeOfType<Events.Clinic.UnavailabilitySlotAdded>();
            this.entity.Events[5].Should().BeOfType<Events.Clinic.UnavailabilitySlotAdded>();
        }
